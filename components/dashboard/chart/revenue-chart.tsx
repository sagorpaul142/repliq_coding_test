...
const RevenueChart = () => {
  return (
    <section className="bg-gray-2">
      <div className="">
        <div
          className="w-full xl:max-w-[760px] rounded-lg border border-stroke bg-white px-5 pb-5 pt-[30px] dark:border-dark-3 dark:bg-dark-2 sm:px-[30px]">
          <div className="flex justify-between">
            <div>
              <h3
                className="mb-1 text-xl font-bold leading-none text-dark dark:text-white sm:text-[28px] sm:leading-[35px]">
                $35,8K
              </h3>
