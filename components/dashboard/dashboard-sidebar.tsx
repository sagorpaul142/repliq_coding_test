                ...
                >
                  <div className="absolute left-full top-0 flex w-16 justify-center pt-5">
                    <button type="button" className="-m-2.5 p-2.5" onClick={() => setSidebarOpen(false)}>
                      ...
                      <Icons.close className="h-6 w-6 text-white" aria-hidden="true"/>
                    </button>
                  </div>
                </Transition.Child>
                ...
                <div className="flex grow flex-col gap-y-5 overflow-y-auto bg-white px-6 pb-4">
                  <div className="flex h-16 shrink-0 items-center mt-6">
                    <Link href="/home" className="w-full flex justify-center">
                      <img className="mx-auto h-16 w-16" src="images/repliq2x-logo.png" alt="logo"/>
                    </Link>
                  </div>
              ...
              <Menu as="div" className="relative">
                <Menu.Button className="-m-1.5 flex items-center p-1.5">
                  ...
                  <img
                    ...
                    src="https://demo.tailgrids.com/templates/levels/build/src/assets/images/avatar/image-05.jpg"
                    alt=""
                  />
