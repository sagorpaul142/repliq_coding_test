...
const OrderSummary = () => {
  return (
    <div className="container mt-5">
      <div className="flex flex-col items-center border-b bg-white sm:flex-row py-4 sm:px-10 lg:px-20 xl:px-32">
      ...
      <div className="grid lg:grid-cols-2">
          ...
          <form className="mt-5 grid gap-6">
            <div className="relative">
              ...
              <label
                ...
                htmlFor="radio_1">
                <Image className="w-14 object-contain" src={imageOne} alt="" width={500} height={50}/>
                <div className="ml-5">
            ...
            <div className="relative">
              ...
              <label
                className="peer-checked:border-2 peer-checked:border-gray-700 peer-checked:bg-gray-50 flex cursor-pointer select-none rounded-lg border border-gray-300 p-4"
                htmlFor="radio_2">
                <Image className="w-14 object-contain" src={imageTwo} alt="" width={500} height={50}/>
                <div className="ml-5">
                  <span className="mt-2 font-semibold">Fedex Delivery</span>
                  <p className="text-slate-500 text-sm leading-6">Delivery: 2-4 Days</p>
                </div>
        ...
        <div className="mt-10 bg-gray-50 lg:px-4 pt-8 lg:mt-0">
              ...
              <div className="relative flex-shrink-0 sm:w-7/12">
                ...
                <div className="pointer-events-none absolute inset-y-0 left-0 inline-flex items-center px-3">
                  <img className="h-4 w-4 object-contain"
                       src="https://flagpack.xyz/_nuxt/f0377e18b4c2435c13a5287c8d3051c9.svg" alt=""/>
                </div>
              </div>
