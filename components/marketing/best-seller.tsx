...
import SallerOne from "@/public/images/seller/saller-1.png"
import SallerTwo from "@/public/images/seller/saller-2.png"
import SallerThree from "@/public/images/seller/saller-3.png"
import SallerFour from "@/public/images/seller/saller-4.png"
import SallerFive from "@/public/images/seller/saller-5.png"
import SallerSix from "@/public/images/seller/saller-6.png"
import Link from "next/link";
import Image from "next/image";

const BestSeller = () => {
  return (
    <div className="section-wrapper w-full mb-[60px] container">
      <div className="">
        <div className=" section-title flex justify-between items-center mb-5">
          <div><h1 className="sm:text-3xl text-xl font-600 text-qblacktext leading-none">Best Saller</h1></div>
          {/*<div>*/}
          {/*  <Link href="#">*/}
          ...
          <div className="w-full ">
            <div className="grid xl:grid-cols-6 lg:grid-cols-5 sm:grid-cols-3 grid-cols-1 xl:gap-[30px] gap-5">
              <div data-aos="fade-left" data-aos-duration="500"
                ...
                <div
                  className="w-[170px] h-[170px] rounded-full bg-white flex justify-center items-center overflow-hidden mb-2">
                  <Image src={SallerOne} alt=""/>
                </div>
                <Link href="#">
              ...
              <div data-aos="fade-left" data-aos-duration="300"
                ...
                <div
                  className="w-[170px] h-[170px] rounded-full bg-white flex justify-center items-center overflow-hidden mb-2">
                  <Image src={SallerThree} alt=""/>
                </div>
                <Link href="#"><p className="text-base font-500 text-center">Fusion X</p></Link></div>
              <div data-aos="fade-left" data-aos-duration="200"
                   className="item w-full flex flex-col items-center aos-init aos-animate">
                <div
                  className="w-[170px] h-[170px] rounded-full bg-white flex justify-center items-center overflow-hidden mb-2">
                  <Image src={SallerFour} alt=""/>
                </div>
                <Link href="#"><p className="text-base font-500 text-center">Rikayi Rox</p></Link></div>
              <div data-aos="fade-left" data-aos-duration="100"
                   className="item w-full flex flex-col items-center aos-init aos-animate">
                <div
                  className="w-[170px] h-[170px] rounded-full bg-white flex justify-center items-center overflow-hidden mb-2">
                  <Image src={SallerFive} alt=""/>
                </div>
                <Link href="#"><p className="text-base font-500 text-center">Habbriyi</p></Link></div>
              <div data-aos="fade-left" data-aos-duration="100"
                   className="item w-full flex flex-col items-center aos-init aos-animate">
                <div
                  className="w-[170px] h-[170px] rounded-full bg-white flex justify-center items-center overflow-hidden mb-2">
                  <Image src={SallerSix} alt=""/>
                </div>
                <Link href="#"><p className="text-base font-500 text-center">Rayhans</p></Link></div>
            </div>
          </div>
        </div>
      </div>
